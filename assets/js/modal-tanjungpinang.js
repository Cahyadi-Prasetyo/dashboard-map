...
function openModal(type, regionKey = 'kepulauan_riau', regionName = 'Kepulauan Riau') {
    ...
    const charts = {
        ...
        inflasi: () => {
            ...
            if (regionKey === 'tanjungpinang') {
                if (typeof dataInflasi !== 'undefined' && dataInflasi.wilayah && dataInflasi.wilayah['tanjungpinang']) {
                    const d = dataInflasi.wilayah['tanjungpinang'].tahunan;
        ...
        wisman: () => {
            ...
            } else if (regionKey === 'tanjungpinang') {
